...
Class.menu_bosses = makeMenu("Bosses", {upgrades: ["sentries", "elites", "mysticals", "nesters", "rogues", "rammers", "terrestrials", "celestials", "eternals", "devBosses"].map(x => "menu_" + x), rerootTree: "menu_bosses"})
    ...
    Class.menu_mysticals = makeMenu("Mysticals", {upgrades: ["sorcerer", "summoner"/*, "thaumaturge"*/, "enchantress", "exorcistor", "shaman", "sangoma", "preacher", "herbalist", "witch"], color: "gold", boxColor: "gold", shape: 4})
